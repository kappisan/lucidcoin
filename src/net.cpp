...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Lucidcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"lucidcointools.com", "192.168.0.6"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"lucidcointools.com", "testnet-seed.lucidcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Lucidcoin is probably already running."), addrBind.ToString().c_str());
        else
